...
FilterBlockBuilder::FilterBlockBuilder(const BloomFilterPolicy *policy) : policy_(policy) {}
...
FilterBlockReader::FilterBlockReader(const BloomFilterPolicy *policy, std::string_view contents)
